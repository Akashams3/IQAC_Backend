...
public class EResourceService {
    ...
    public List<EResource> getAll(Long deptId, String academicYear,
        ...
        return repo.findByFilters(deptId, yp[0], yp[1], className, subject, typeUpper, statusEnum);
    }
    ...
    public void update(Long id, Long facultyId, Long deptId, String title, String subject,
        ...
        r.setAcademicYear(AcademicYearUtil.normalizeToShort(AcademicYearUtil.blankToNull(academicYear)));
