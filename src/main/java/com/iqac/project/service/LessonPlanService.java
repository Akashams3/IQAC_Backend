...
public class LessonPlanService {
    ...
    public List<LessonPlan> getByDept(Long deptId, String academicYear) {
        ...
        if (AcademicYearUtil.blankToNull(academicYear) != null) {
            String[] yp = AcademicYearUtil.filterPair(academicYear);
            return repo.findByDepartmentIdAndAcademicYearFlexible(deptId, yp[0], yp[1]);
        }
    ...
    public void update(Long id, Long deptId, LessonPlanRequest req) {
        ...
        lp.setAcademicYear(AcademicYearUtil.normalizeToShort(AcademicYearUtil.blankToNull(req.getAcademicYear())));
