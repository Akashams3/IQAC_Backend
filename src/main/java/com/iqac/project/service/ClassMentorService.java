...
public class ClassMentorService {
    ...
    public void create(Long deptId, ClassMentorRequest req) {
        ...
        if (repo.countByFacultyIdAndAcademicYearEither(req.getFacultyId(), yp[0], yp[1]) > 0)
    ...
    public List<ClassMentorResponse> getAll(Long deptId, String academicYear) {
        ...
        List<ClassMentor> list = yp[0] != null
    ...
    public void deleteByYear(Long deptId, String academicYear) {
        ...
        String[] yp = AcademicYearUtil.filterPair(academicYear);
        if (repo.countByDepartmentIdAndAcademicYearEither(deptId, yp[0], yp[1]) == 0)
